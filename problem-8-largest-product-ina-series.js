...
let greatestProduct = 0;
  ...
  for (let i=0; i<=thousandDigits.length; i++) {
    const arr = thousandDigits.slice(i, i + n);
...
//take n digit numbers from start 0 1 2 3
// store product = 0*1*2*3
// move to 1234 => create product 1*2*3*4
//compare => if 2nd is bigger than product = 2nd then move onto next => 2345